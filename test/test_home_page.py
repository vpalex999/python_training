...
def test_view_contact_from_home_page_by_index(app, address):
    ...
    if address_from_home_page.lname is None:
        address_from_home_page.lname = ""
    assert address_from_home_page.lname == clear(address_from_edit_page.lname)
    if address_from_home_page.name is None:
        address_from_home_page.name = ""
    ...
    assert clear(address_from_home_page.all_email_from_home_page) == merge_email_like_on_home_page(
        address_from_edit_page)
    if address_from_home_page.all_phones_from_home_page is None:
        address_from_home_page.all_phones_from_home_page = ""
    assert clear(address_from_home_page.all_phones_from_home_page) == merge_phones_like_on_home_page(
        address_from_edit_page)
